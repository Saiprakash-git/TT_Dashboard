                ...
                {userPreference ? (
                  <div className="space-y-3">
                    ...
                    <p className="text-sm text-muted-foreground">
                      You've ranked {userPreference.rankedSubjects?.length || 0} subject(s). Last updated:{' '}
                      {userPreference.updatedAt ? new Date(userPreference.updatedAt).toLocaleDateString() : 'N/A'}
                    </p>
